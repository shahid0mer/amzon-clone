    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center pt-8 sm:pt-16">
      ...
      <div className="w-full max-w-sm p-6 bg-white border border-gray-300 rounded-lg shadow-sm">
        ...
        <div className="mt-4 border-t border-gray-200 pt-4">
          ...
          <a className="text-sm text-blue-600 hover:text-red-700 hover:underline">Create a free business account</a>
        </div>
        ...
        <button className="w-full py-1.5 bg-white hover:bg-gray-50 text-sm border border-gray-400 rounded-sm flex items-center justify-center space-x-2"
        ...
        >
          ...
          >
            <path d="M22.56 12.25c0-.62-.05-1.22-.17-1.81H12v3.42h5.88c-.26 1.37-1.04 2.53-2.21 3.32v2.66h3.42c2.01-1.85 3.17-4.57 3.17-7.61z" fill="#4285F4"/>
            <path d="M12 23c3.24 0 5.95-1.08 7.94-2.93l-3.42-2.66c-1.02.68-2.33 1.08-3.92 1.08-3.03 0-5.59-2.05-6.51-4.83H1.93v2.75C3.92 20.32 7.64 23 12 23z" fill="#34A853"/>
            <path d="M5.49 14.18c-.24-.68-.38-1.42-.38-2.18s.14-1.5.38-2.18V7.15H1.93c-.76 1.54-1.16 3.28-1.16 5.07s.4 3.53 1.16 5.07l3.56-2.92z" fill="#FBBC05"/>
            <path d="M12 4.67c1.77 0 3.34.61 4.59 1.78l3.05-3.04C17.95 1.53 15.24.4 12 .4 7.64.4 3.92 3.12 1.93 7.15l3.56 2.92c.92-2.78 3.48-4.83 6.51-4.83z" fill="#EA4335"/>
          </svg>
      ...
      <div className="w-full mt-10 border-t border-gray-300 pt-5 pb-10 bg-gray-100 flex flex-col items-center">
        <div className="flex space-x-4 text-xs">
          <a className="text-blue-600 hover:text-red-700 hover:underline">Conditions of Use</a>
          <a className="text-blue-600 hover:text-red-700 hover:underline">Privacy Notice</a>
          <a className="text-blue-600 hover:text-red-700 hover:underline">Help</a>
        </div>
