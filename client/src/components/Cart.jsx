...
import {fetchCart, addToCart, removeFromCart, updateCartQuantity } from '../Features/cartThunk';
...
function Cart() {
  ...
  const handleQtyChange = (e, productId) => {
    dispatch(updateCartQuantity({ productId, quantity: Number(e.target.value) }));
  };
      ...
      <div className="max-w-7xl mx-auto p-4">
        <div className="flex gap-4">
          ...
          <div className="flex-1 bg-white p-6 rounded">
            ...
            {items.map(item => (
              <div key={item.product._id} className="flex items-start border-b border-gray-300 pb-6 mb-4">
                <img
                ...
                <div className="flex-1">
                  <h2 className="text-lg font-medium mb-2 text-black">{item.product.name}</h2>
