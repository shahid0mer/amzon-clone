  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center pt-8 sm:pt-16">
      ...
      <div className="w-full max-w-sm p-6 bg-white border border-gray-300 rounded-lg shadow-sm">
        ...
        <div className="mt-4">
          <a href="#" className="text-sm text-blue-600 hover:text-red-700 hover:underline flex items-center">
            <svg
        ...
        <div>
          ...
          <a href="#" className="text-sm text-blue-600 hover:text-red-700 hover:underline">
      ...
      <Link to ="/signup" >
        <button
          className="w-full py-1.5 bg-gray-100 hover:bg-gray-200 text-sm border border-gray-400 rounded-sm shadow-sm mb-4"
        >
